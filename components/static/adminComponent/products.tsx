...
export const Products = () => {
  ...
  const addProperty = () => {
    if (!editingProduct || !currentProperty.key || !currentProperty.value) return;
    setEditingProduct({
      ...editingProduct,
      properties: {
  ...
  return (
    <div className="p-6" dir="rtl">
      <h2 className="text-2xl font-bold mb-6 mt-20">مدیریت محصولات</h2>
          ...
          <div key={product._id} className="border rounded-lg p-4 shadow">
            ...
            <div className="mt-4 flex gap-2">
              <button 
                ...
                className="bg-[#a37462] text-white px-4 py-2 rounded hover:bg-[#a37462]/80"
              >
                ویرایش
              </button>
              <button 
          ...
          <div className="bg-white p-6 rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleUpdate} className="space-y-6">
              ...
              <div>
                ...
                <div className="flex gap-2 mb-2">
                  ...
                  <button
                    type="button"
                    onClick={addProperty}
                    className="px-4 py-2 bg-[#a37462] text-white rounded hover:bg-[#a37462]/80"
                  >
                    افزودن ویژگی
                  </button>
                </div>
                <div className="mt-2">
                  {Object.entries(editingProduct.properties).map(([key, value]) => (
                    <div key={key} className="inline-block bg-[#a37462]/10 text-[#a37462] rounded px-3 py-1 m-1">
                      {key}: {value}
                    </div>
                  ))}
                </div>
              ...
              <div>
                ...
                <div className="mt-2">
                  {Object.entries(editingProduct.colors).map(([name, code]) => (
                    <div key={name} className="inline-block bg-[#a37462]/10 text-[#a37462] rounded px-3 py-1 m-1">
                      {name}: {code}
                    </div>
                  ))}
                </div>
              ...
              <div>
                ...
                <div className="mt-2">
                  {editingProduct.videoes.map((video, index) => (
                    <div key={index} className="inline-block bg-[#a37462]/10 text-[#a37462] rounded px-3 py-1 m-1">
                      {video}
                    </div>
                  ))}
                </div>
              ...
              <div className="flex gap-2 justify-end mt-6">
                <button 
                  type="submit" 
                  className="bg-[#a37462] text-white px-6 py-2 rounded hover:bg-[#a37462]/80"
                >
                  ذخیره تغییرات
                </button>
                <button 
