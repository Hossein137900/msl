...
const MenuButton: React.FC<MenuButtonProps> = ({ onClick, active, children }) => (
    <button
        onClick={onClick}
        className={`p-2 rounded ${active ? 'bg-[#a37462] text-white' : 'hover:bg-[#e5d8d0]'}`}
    >
        {children}
    </button>
);
...
export default function EditBlog() {
    ...
    const MenuButton = ({
        ...
        <button
            type="button"
            onClick={onClick}
            className={`p-2 rounded-md transition-colors ${active ? "bg-blue-100 text-blue-600" : "hover:bg-gray-100 text-gray-600"
                }`}
        >
            {children}
        </button>
    ...
    return (
        <div className="min-h-screen p-6" dir="rtl">
            ...
            <h1 className="text-3xl font-bold text-[#a37462] mb-8">مدیریت بلاگ‌ها</h1>
                ...
                >
                    <div className="space-y-4">
                        ...
                        <div className="mt-6 flex gap-4">
                            <button
                                type="submit"
                                className="bg-[#a37462] text-white px-6 py-2 rounded hover:bg-[#8b6351]"
                            >
                                ذخیره تغییرات
                            </button>
                            <button
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {blogs.map((blog) => (
                        ...
                        >
                            ...
                            <div className="p-4">
                                <h2 className="text-xl font-bold text-[#a37462] mb-2">{blog.title}</h2>
                                <p className="text-gray-600 mb-4 line-clamp-2">{blog.description}</p>
                                <div className="flex justify-between items-center">
                                    <button
                                        onClick={() => handleEdit(blog)}
                                        className="bg-[#a37462] text-white px-4 py-2 rounded hover:bg-[#8b6351]"
                                    >
                                        ویرایش
                                    </button>
                                    <button
